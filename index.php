...
<body>
    <div align="center" class="row">
        <div class="col-sm-3">
            <p align="left">Bill subtotal: $</p>
        </div>
        <div class="col-sm-9">
            <input type="number" class="form-control" placeholder="Enter subtotal">
        </div>
    </div>
<div align="center" class="row">
<div class="col-sm-3">
<p align="left">Tip Percentage:</p>
</div>
</div>
<div align="center" class="row">
...
<label align="left" class="radio-inline"><input type="radio" name="optradio">Custom %:</label>
</div>
